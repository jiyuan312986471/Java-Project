...
<head>
	...
	<link rel="stylesheet" href="<%= request.getContextPath()%>/ext/bootstrap/3.3.2/css/bootstrap.min.css">
	<!-- Optional theme -->
	<!-- <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.2/css/bootstrap-theme.min.css"> -->
	<link rel="stylesheet" href="<%= request.getContextPath()%>/ext/bootstrap/3.3.2/css/bootstrap-theme.min.css">
	...
	<script src="<%= request.getContextPath()%>/ext/bootstrap/3.3.2/js/bootstrap.min.js"></script>
	
	<!-- Bootstrap Progress Bar -->
	<script type="text/javascript" src="<%= request.getContextPath()%>/ext/bootstrap-progressbar-0.8.4/bootstrap-progressbar.js"></script>
